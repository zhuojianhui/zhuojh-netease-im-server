...
/**
 * Function: 更新并获取新token请求对象. <br>
 * Reason: TODO ADD REASON. <br>
 * Date: 2019年1月21日 下午4:08:06
 * @author zhuojianhui@gmail.com
 * @since 1.0
 * @description 更新并获取新token请求对象。<br>
 *              POST https://api.netease.im/nimserver/user/refreshToken.action HTTP/1.1 <br>
 *              Content-Type:application/x-www-form-urlencoded;charset=utf-8 <br>
 *              接口描述 1.webserver更新网易云通信ID的token，同时返回新的token；<br>
 *              2.一般用于网易云通信ID修改密码，找回密码或者第三方有需求获取新的token。<br>
 */
public class UserRefreshTokenRequest extends BaseHttpRequest {
