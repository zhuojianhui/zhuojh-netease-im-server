...
/**
 * Function: 查看指定用户的黑名单和静音列表请求对象. <br>
 * Reason: TODO ADD REASON. <br>
 * Date: 2019年1月21日 下午4:08:06
 * @author zhuojianhui@gmail.com
 * @since 1.0
 * @description 查看指定用户的黑名单和静音列表请求对象。<br>
 *              POST https://api.netease.im/nimserver/user/listBlackAndMuteList.action HTTP/1.1 <br>
 *              Content-Type:application/x-www-form-urlencoded;charset=utf-8 <br>
 *              接口描述：查看用户的黑名单和静音列表。<br>
 */
public class UserListBlackAndMuteListRequest extends BaseHttpRequest {
