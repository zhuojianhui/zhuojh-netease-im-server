...
/**
 * Function: 账号全局禁言请求对象. <br>
 * Reason: TODO ADD REASON. <br>
 * Date: 2019年1月21日 下午4:08:06
 * @author zhuojianhui@gmail.com
 * @since 1.0
 * @description 账号全局禁言请求对象。<br>
 *              POST https://api.netease.im/nimserver/user/mute.action HTTP/1.1 <br>
 *              Content-Type:application/x-www-form-urlencoded;charset=utf-8 <br>
 *              接口描述：设置或取消账号的全局禁言状态； <br>
 *              账号被设置为全局禁言后，不能发送“点对点”、“群”、“聊天室”消息。<br>
 */
public class UserMuteRequest extends BaseHttpRequest {
